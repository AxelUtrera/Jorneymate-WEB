...
namespace Logic
{
    public static class RoutineLogic
    {
        ...
        public static async Task<Routine> GetDetailsRoutine(string idRoutine)
        {
            Routine routineObtained = null;
            ...
            try
            {
                ...
                if (messageResponse.IsSuccessStatusCode)
                {
                    ApiResponseRoutineDetails routinesDescerialized = JsonConvert.DeserializeObject<ApiResponseRoutineDetails>(jsonResponse);
                    routineObtained = routinesDescerialized.Response;
                }
            }
            catch (Exception ex)
            {
        ...
        public static async Task<string> SaveRoutine(string username, Routine routine)
        {
            ...
            try
            {
                var data = new
                {
                    ...
                    routine_description = routine.RoutineDescription,
                    visibility = routine.Visibility,
                    label_category = routine.LabelCategory,
                    state_country = routine.StateCountry,
                    town = routine.Town
                };
        ...
        public static async Task<int> UpdateRoutine(string idRoutine, Routine routineToUpdate)
        {
            ...
            try
            {
                var data = new
                {
                    ...
                    routine_description = routineToUpdate.RoutineDescription,
                    visibility = routineToUpdate.Visibility,
                    label_category = routineToUpdate.LabelCategory,
                    state_country = routineToUpdate.StateCountry,
                    town = routineToUpdate.Town,
                    followers = routineToUpdate.Followers,
                    routine_creator = routineToUpdate.RoutineCreator
                };
                string dataToSend = JsonConvert.SerializeObject(data);
