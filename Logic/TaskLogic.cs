...
namespace Logic
{
    public class TaskLogic
    {
        ...
        public static async Task<List<Jorneymate_WEB.Models.Task>> GetTasksByRoutineId(string idRoutine)
        {
            List<Jorneymate_WEB.Models.Task> tasks = null;
        ...
        public static async System.Threading.Tasks.Task<int> AddNewTaskToRoutine(string idRoutineCreated, Jorneymate_WEB.Models.Task taskToRoutine)
        {
            ...
            try
            {
                ...
                var dataTask = new
                {
                    ...
                    task_description = taskToRoutine.TaskDescription,
        ...
        public static async System.Threading.Tasks.Task<int> EditTask(Jorneymate_WEB.Models.Task taskToEdit)
        {
            int codeStatus = (int)StatusCode.ProccessError;
            try
            {
                ...
                var dataTask = new
                {
                    ...
                    task_description = taskToEdit.TaskDescription,
